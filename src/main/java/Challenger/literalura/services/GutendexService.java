package Challenger.literalura.services;
...
public class GutendexService {
    ...
    public List<BooksDTO> searchBooks(String query) throws Exception {
    ...
    private static class GutendexResponse {
        private List<BooksDTO> results;

        public List<BooksDTO> getResults() {
            return results;
        }
    }
}
