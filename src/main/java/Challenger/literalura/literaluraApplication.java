...
import Challenger.literalura.repository.BooksRepository;
import Challenger.literalura.services.GutendexService;
...
public class literaluraApplication implements CommandLineRunner {
	...
	private void findBookByTitle(Scanner scanner) {
		...
		try {
			List<BooksDTO> books = gutendexService.searchBooks(title);
			...
			if (books.isEmpty()) {
				...
				Books book = new Books(books.get(index));
